  ...
  return (
      <>
        ...
        <div className='flex flex-row justify-start w-5/6 items-center'>
          <StyledAutocomplete data={professors} value={formData.professor} setValue={handleProfChange} label="Choose instructor" placeholder="Pick an instructor" className="w-1/2"/>
