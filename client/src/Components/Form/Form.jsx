...
export const Form = () => {
  ...
  return (
    ...
    >
      <Card className="w-2/3 text-black bg-white rounded-md mx-auto flex flex-col shadow-lg">
        ...
        <Divider />
        <CardBody className="my-8 flex flex-col justify-center items-center gap-8">
          {step === 0 && <Step1 />}
        </CardBody>
        <Divider />
      </Card>
